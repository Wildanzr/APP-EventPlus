      ...
      <div className="flex flex-col mb-20 w-10/12">
        ...
        <div className="flex shrink w-40 bg-[#BFD9D7] rounded-full">
          <div className="inline-flex rounded-lg bg-[#BFD9D7]">
            ...
            <label htmlFor="roomPrivate" className="radio w-20 text-center text-sm self-center py-0.5 px-4 rounded-full cursor-pointer">Sign In</label>
          </div>
          <div className="inline-flex rounded-lg bg-[#BFD9D7]">
            <input type="radio" name="room_type" id="roomPublic" hidden/>
            <label htmlFor="roomPublic" className="radio w-20 text-center text-sm self-center py-0.5 px-4 rounded-full cursor-pointer">Sign Up</label>
          </div>
        </div>
      </div>
